    ...
    function processMessage(request) {
        ...
        switch (request.message) {
            case 'iframes-loaded':
                ...
                break;
            case 'start-widget':
                message_onStartWidget(request.data);
                break;
            case 'suspend-widget':
                message_onSuspendWidget();
                break;
            case 'back-clicked':
                logDebug('back botton clicked, send message to background ...');
                message_onBackClickced();
                break;
            case 'flush-url':
                message_onFlushURL(request.message, request.data);
                break;
        }
    };
